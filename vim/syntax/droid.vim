...
" droid
syn match droidOutputParameter "^\s*controllererrors" contained
...
syn match motoquencerInputParameter "^\s*bar" contained
...
syn match motoquencerOutputParameter "^\s*cv1" contained
syn match motoquencerOutputParameter "^\s*cv2" contained
syn match motoquencerOutputParameter "^\s*cv3" contained
syn match motoquencerInputParameter "^\s*cvdefault" contained
syn match motoquencerInputParameter "^\s*cvdefault1" contained
syn match motoquencerInputParameter "^\s*cvdefault2" contained
syn match motoquencerInputParameter "^\s*cvdefault3" contained
syn match motoquencerInputParameter "^\s*degree" contained
syn match motoquencerInputParameter "^\s*faderblock" contained
syn match motoquencerInputParameter "^\s*faderblock1" contained
syn match motoquencerInputParameter "^\s*faderblock2" contained
syn match motoquencerInputParameter "^\s*fadermode" contained
syn match motoquencerOutputParameter "^\s*gate" contained
syn match motoquencerOutputParameter "^\s*gate1" contained
syn match motoquencerOutputParameter "^\s*gate2" contained
syn match motoquencerOutputParameter "^\s*gate3" contained
syn match motoquencerOutputParameter "^\s*pitch" contained
syn match motoquencerInputParameter "^\s*pitchbase" contained
syn match motoquencerInputParameter "^\s*pitchrange" contained
syn match motoquencerInputParameter "^\s*quantize" contained
syn match motoquencerInputParameter "^\s*recall" contained
...
syn match motoquencerInputParameter "^\s*snapshot" contained
syn match motoquencerInputParameter "^\s*stepoffset" contained
